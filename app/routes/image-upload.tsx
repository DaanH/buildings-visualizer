...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    // Import the mock API processing logic
    ...
    console.log("API response data:", mockResponse);
    ...
    <div className="container mx-auto p-8">
      ...
      {isSubmitting && !actionData?.response && (
        <div className="mt-8 p-6 bg-gray-50 rounded-lg shadow flex flex-col items-center justify-center">
          ...
          <p className="text-gray-500 mt-4">Processing your image and prompt...</p>
        </div>
      )}
        ...
        <div className="mt-8 p-6 bg-gray-50 rounded-lg shadow">
          ...
          <div className="mt-4 flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-1/3">
              <p className="text-sm text-gray-700 mb-2">Processed Image:</p>
              <div className="border border-gray-300 rounded-md overflow-hidden">
                <img
                  src={actionData.response.image}
                  alt="Processed"
